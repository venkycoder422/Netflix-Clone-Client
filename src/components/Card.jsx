...
import video from '../assets/StrangeTrailer.mp4';
import { useNavigate } from 'react-router-dom';
import { IoPlayCircleSharp } from 'react-icons/io5'
import { RiThumbUoFill, RiThumbDownFill, RiThumbUpFill } from 'react-icons/ri'
...
export default function Card({ movieData, isLiked = false }) {
  ...
  >
    <img src={`https://image.tmdb.org/t/p/w500${movieData.image}`} alt="movie"></img>
    {
      isHovered && (
        <div className="hover">
